...
impl AgentRole for CriticRole {
    ...
    async fn execute(
        ...
        let findings = blackboard.get("researcher/findings.json")
            .unwrap_or_default();
        let findings_md = blackboard.get("researcher/findings.md")
            .unwrap_or_default();
        let prior_critique = blackboard.get("critic/critique.json");
...
"#
        ...
        blackboard.put("critic/critique.json", &json)?;
        ...
        blackboard.put("critic/critique.md", &md)?;
