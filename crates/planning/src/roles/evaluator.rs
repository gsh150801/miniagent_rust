...
impl AgentRole for EvaluatorRole {
    ...
    async fn execute(
        ...
        let review = blackboard.get("reviewer/review.json")
            .or_else(|| blackboard.get("reviewer/review.md"))
            .unwrap_or_default();
        let synthesis = blackboard.get("synthesizer/synthesis.json")
            .unwrap_or_default();
        let critique = blackboard.get("critic/critique.json")
            .unwrap_or_default();
        let report = blackboard.get("writer/draft.md")
            .or_else(|| blackboard.get("writer/report.json"))
            .unwrap_or_default();
        let prior_eval = blackboard.get("evaluator/evaluation.json");
...
"#
        ...
        blackboard.put("evaluator/evaluation.json", &json)?;
        ...
        blackboard.put("evaluator/evaluation.md", &md)?;
        ...
        if let Some(decision) = parsed.metadata.get("decision")
            && decision == "ITERATE" {
                ...
                blackboard.put("todo.md", &new_todo)?;
            }
