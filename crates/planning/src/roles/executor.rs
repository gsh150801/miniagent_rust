...
impl AgentRole for ExecutorRole {
    ...
    async fn execute(
        ...
        let plan = blackboard.get("planner/current_plan.json");
        let prior_output = blackboard.get("executor/output.json");
...
"#,
        ...
        blackboard.put("executor/output.json", &json)?;
        ...
        blackboard.put("executor/report.md", &md)?;
