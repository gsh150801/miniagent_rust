...
impl AgentRole for JudgeRole {
    ...
    async fn execute(
        ...
        let hypothesis = blackboard.get("proposer/hypothesis.json")
            .unwrap_or_default();
        let critique = blackboard.get("opponent/critique.json")
            .unwrap_or_default();
        let scores = blackboard.get("opponent/scores.json")
            .unwrap_or_default();
...
"#
        ...
        blackboard.put("judge/verdict.json", &output_json)?;
        ...
        blackboard.put("judge/decision.json",
