...
impl AgentRole for ReviewerRole {
    ...
    async fn execute(
        ...
        let findings = blackboard.get("researcher/findings.json")
            .unwrap_or_default();
        let critique = blackboard.get("critic/critique.json")
            .unwrap_or_default();
        let synthesis = blackboard.get("synthesizer/synthesis.json")
            .unwrap_or_default();
        let report = blackboard.get("writer/report.json")
            .or_else(|| blackboard.get("writer/draft.md"))
            .unwrap_or_default();
        let executor_output = blackboard.get("executor/output.json");
...
"#
        ...
        blackboard.put("reviewer/review.json", &json)?;
        ...
        blackboard.put("reviewer/review.md", &md)?;
