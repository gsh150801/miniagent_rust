...
impl AgentRole for SupervisorRole {
    ...
    async fn execute(
        ...
        let prior_plan = blackboard.get("supervisor/plan.json");
        let progress = blackboard.get("supervisor/progress.md");
...
"#,
        ...
        blackboard.put("supervisor/plan.json", &plan_json)?;
        ...
        blackboard.put("todo.md", &todo_content)?;
