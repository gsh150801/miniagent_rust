...
impl StageContext {
    pub fn new(
        ...
        previous_outputs: std::collections::HashMap<StageId, serde_json::Value>,
        cancel: CancellationToken,
    ) -> Self {
        Self { stage_id, input, previous_outputs, cancel }
    }
}
...
pub trait StageHandler: Send + Sync {
    ...
    /// Execute this stage with a cancellation token.
    async fn execute_with_cancel(&self, ctx: &StageContext) -> Result<StageOutput, StageError> {
